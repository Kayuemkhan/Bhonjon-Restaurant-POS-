package com.bdtask.bhojonrestaurantpos;
...
public class Tools {
    ...
    public static void setSystemBarColor(Activity act) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(act.getResources().getColor(R.color.design_default_color_primary_dark));
        }
    }
    ...
    public static void clearSystemBarLight(Activity act) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            Window window = act.getWindow();
            window.setStatusBarColor(ContextCompat.getColor(act, R.color.design_default_color_primary_dark));
        }
    }
