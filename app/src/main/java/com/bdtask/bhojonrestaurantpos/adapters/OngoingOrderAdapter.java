...
//            }
//            ongoingOrderFragment.showingLowerpartOfLayout(aBoolean);
//        });
//        if (row_index == i) {
//
...
//            SharedPref.write("OrderID",ongoingOrderData.get(row_index).getOrderid());
...
//            if(ongoingOrderFragment.checkChoiceTable() == true){
//               ongoingOrderFragment.setTableData( ongoingOrderData.get(i).getOrderid(),ongoingOrderData.get(i).getGrandtotal());
//            }
//            else
            ongoingOrderFragment.showingLowerpartOfLayout(aBoolean);

            if (ongoingOrderFragment.checkChoiceTable() == true && ongoingOrderFragment.checktableExistence(ongoingOrderData.get(i).getOrderid()) == 0) {
                ongoingOrderFragment.setTableData(ongoingOrderData.get(i).getOrderid(), ongoingOrderData.get(i).getGrandtotal());
                holder.tabledetailslayout.setBackgroundResource(R.color.back);
                holder.ongoingOrderCustomerName.setTextColor(Color.parseColor("#FFFFFF"));
                holder.ongoingOrderOderId.setTextColor(Color.parseColor("#FFFFFF"));
                ...
                ongoingOrderFragment.checktableExistence(ongoingOrderData.get(i).getOrderid());
                holder.tabledetailslayout.setBackgroundColor(0xFFFFFFFF);
                holder.ongoingOrderCustomerName.setTextColor(Color.parseColor("#000000"));
                holder.ongoingOrderOderId.setTextColor(Color.parseColor("#000000"));
                holder.ongoingOrderWaiterName.setTextColor(Color.parseColor("#000000"));
